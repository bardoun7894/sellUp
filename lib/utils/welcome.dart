...
class _WelcomePageState extends State<WelcomePage> {
  ...
  List<WelcomeModel> welecomes = [
    WelcomeModel("assets/shop_vector1.png", " UseSell App",
        "Praesent tellus mauris, tincidunt nec ipsum id, faucibus pellentesque leo. Nunc congue ac tellus quis porttitor. "),
    WelcomeModel("assets/shop_vector2.png", " UseSell App",
        "Praesent tellus mauris, tincidunt nec ipsum id, faucibus pellentesque leo. Nunc congue ac tellus quis porttitor. "),
    WelcomeModel("assets/shop_vector3.png", " UseSell App",
        "Praesent tellus mauris, tincidunt nec ipsum id, faucibus pellentesque leo. Nunc congue ac tellus quis porttitor. "),
    WelcomeModel("assets/shop_vector4.png", " UseSell App",
        "Praesent tellus mauris, tincidunt nec ipsum id, faucibus pellentesque leo. Nunc congue ac tellus quis porttitor. "),
    WelcomeModel("assets/shop_vector5.png", "Download , call, go ",
        "Praesent tellus mauris, tincidunt nec ipsum id, faucibus pellentesque leo. Nunc congue ac tellus quis porttitor. "),
  ];
  ...
  Widget build(BuildContext context) {
    ...
    double offSet = sizeConfig.screenHeight * 0.185;
  ...
  List<Widget> _newPageIndicator() {
    ...
    for (int i = 0; i < welecomes.length; i++) {
      _widgets.add(indicatorPage(
          currentPosition == i ? Color(0xFF2785E2) : Color(0xFF9FC8F0),
